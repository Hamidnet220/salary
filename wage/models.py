...
class WageDetail(models.Model):
    ...
    work_days               = models.SmallIntegerField(defualt=0,verbose_name=u"تعداد روز کارکرد")
    absent_days             = models.SmallIntegerField(defualt=0,verbose_name=u"روز غیبت")
    tiemoff_days            = models.SmallIntegerField(defualt=0,verbose_name=u"روز مرخصی")
    workdays_in_friday      = models.SmallIntegerField(defualt=0,verbose_name=u"جمعه کاری")
    workdays_in_holiday     = models.SmallIntegerField(defualt=0,verbose_name=u"تعطیل کاری")
    work_as_replace         = models.SmallIntegerField(defualt=0,verbose_name=u"جایگزینی")
    workdays_in_mission     = models.SmallIntegerField(defualt=0,verbose_name=u"ماموریت")
    ...
    public_message          = models.TextField(blank=True,nll=True,verbose_name=u"پیام عمومی")
    private_message         = models.TextField(blank=True,nll=True,verbose_name=u"پیام اختصاصی")             
